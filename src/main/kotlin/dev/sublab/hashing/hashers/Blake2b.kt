...
/**
 * Hashes via [Blake2b] with output size of 128
 */
fun Hashing.blake2b_128() = blake2b(128)

/**
 * Hashes via [Blake2b] with output size of 160
 */
fun Hashing.blake2b_160() = blake2b(160)

/**
 * Hashes via [Blake2b] with output size of 256
 */
fun Hashing.blake2b_256() = blake2b(256)

/**
 * Hashes via [Blake2b] with output size of 384
 */
fun Hashing.blake2b_384() = blake2b(384)

/**
 * Hashes via [Blake2b] with output size of 512
 */
