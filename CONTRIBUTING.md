# Contributing to Sublab's Hashing repository for Kotlin
...
If you have encountered malfunctioning behavior of our produced codebase, please feel free to open an Issue under [Issues section](https://github.com/sublabdev/hashing-kotlin/issues) with Bug Report template type on this GitHub repository.
...
If you find our library very useful, which we would love to see, but still miss some functionality, please feel free to open an Issue under [Issues section](https://github.com/sublabdev/hashing-kotlin/issues) with Feature Request template type on this GitHub repository. 
...
If you have developed a feature, please post this under [Pull Requests section](https://github.com/sublabdev/hashing-kotlin/pulls) of our GitHub repository, and don't forget about some rules:
